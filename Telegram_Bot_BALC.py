...
# GLOBAL VARIABLES
BOT_TOKEN = '1067499801:AAFmdUOwLgfLkVSozXzx7rO9LK4lyFy0HgQ' #Monik token
#BOT_TOKEN = '918870404:AAGylpk_4euuNUUMidmVGI3csLBslhxJiwE' # shyam token
#BOT_TOKEN = '1041067816:AAGs8q9twShkbPzQl7PERor5Szdjn5Hs-Z0' #Harshita token
...
def text_analytics(update, context):
        images_dir = 'C:\\Users\\14694\\Documents\\Education\\Project\\text_analytics_images'
...
def load_seattle_model():
    ...
    start = time.time()
    SEATTLE_MODEL = joblib.load('C:\\Users\\14694\\Documents\\Education\\Project\\SeattleModel (1).pkl')
...
def load_airbnb_model():
    global AIRBNB_MODEL
    start = time.time()
    AIRBNB_MODEL = joblib.load('C:\\Users\\14694\\Documents\\Education\\Project\\model (2).pkl')
    logger.info(f'Time taken to load Airbnb model is {time.time() - start} Secs')


def load_text_anal():
    global BEST_CONCEPT, BEST_GRADE, BALANCE
    df = pd.read_csv('C:\\Users\\14694\\Documents\\Education\\Project\\responses.csv', encoding="ISO-8859-1")
